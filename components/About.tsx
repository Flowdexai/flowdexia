        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-300 mb-8">
              Somos una empresa especializada en automatización empresarial con más de 2 años de experiencia 
              transformando negocios a través de tecnología avanzada e innovación constante.
            </p>
