      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-blue-500 text-white text-lg font-semibold rounded-lg hover:bg-blue-600 transition-colors cursor-pointer whitespace-nowrap">
              Comenzar Ahora
            </button>
            <button className="px-8 py-4 border-2 border-blue-500 text-blue-400 text-lg font-semibold rounded-lg hover:bg-blue-500 hover:text-white transition-colors cursor-pointer whitespace-nowrap">
              Ver Servicios
            </button>
          </div>
        </div>
